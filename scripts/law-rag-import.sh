...
#   RELEASE_TAG   リリースタグ（既定 law-rag-20260705＝e-Gov 取得日 law-rag-YYYYMMDD）
...
使い方:
  ...
  $(basename "$0") --from-release      GitHub Release から取得して投入
                                       （既定 sanpoyoshi-commons / law-rag-20260705。上書きは環境変数）
EOS
}
...
download_from_release() {
  ...
  local tag="${RELEASE_TAG:-law-rag-20260705}"
